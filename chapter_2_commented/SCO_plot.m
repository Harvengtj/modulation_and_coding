...
% % === Gardner ===
% [downsampled_signal_rx_corrected,time_error] = gardner(downsampled_signal_rx,K,2); % Oversample by 2
% 
% % === Data acquisition ===
...
iter_signal_rx((iter-1)*length(EbN0)+1:iter*length(EbN0), 1:Nsymb) = downsampled_signal_rx;
