...
ppm = 1*(1e-6);         % PPM
phi_0 = [0.05 0.1 0.15 0.2 0.25]; % Phase offset 
K = 0.05;               % Kappa
timeShift = 0.02*Tsymb;          % Time shift
pilot_pos = 34;
pilot_size = 20;
avgWindow_size = 8;
nb_iter = 5;
...
% 
% CFO = exp(1i*2*pi*(ppm*Fc)*t_axis); % CFO
% 
% CPE computation
CPE = exp(1i*phi_0(iter)); % CPE
% 
% % Total shift
shift = CPE;
% 
...
% 
% %% === Sampling Carrier Offset ===
% downsampled_signal_rx = circshift(cropped_filtered_signal_rx,timeShift);
...
legend('CPE = 0.05', 'CPE = 0.1','CPE = 0.15', 'CPE = 0.20','CPE = 0.25', 'Location','southwest');                             % Add a legend
